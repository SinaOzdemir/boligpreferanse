...
data = pd.read_csv("clustering_maxdeep_encoder.csv")
...
#.to_excel(save_dir+"/survey_res_kmeans_2n.xlsx")
...
data = pd.read_csv("clustering_powerdeep_encoder.csv")
col_names = data.columns.tolist()
...
affinityProp_fit = AffinityPropagation(damping = .65,max_iter=1000,convergence_iter=15,random_state=5).fit(data)
