...
clusteringVars = [x for x in colnames if x.startswith("Q20")]
...
save_dir = os.path.normpath(r"C:\Users\sioz\Desktop\arbeid\prosjektene\boligpreferanse\data\survey\survey results\clustering_data")
...
for modus in scaling_modes:
    ...
    transformed_data.to_csv(save_dir + data_name,index=False)
